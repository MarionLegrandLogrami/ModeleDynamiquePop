# Combinaison des scénarios Poutes et amélioration de la survie
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Poutes 50% x Amélioration survie 50%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mean(bugs_level_s)#1.182542
mean(bugs_level_s)/2#0.591271
a=(mean(bugs_level_s)/2)/10#0.0591271 = augmentation annuelle de level_s_fake

level_s_fake=array(0,dim=c(1,T+20))
for (t in (T+1):(T+10)){			#On augmente progressivement
	level_s_fake[t]=level_s_fake[t-1]+a
}
...
plot(1,1,type="n",axes=FALSE,xlim=c(0.5,20.5),xlab="Years",ylim=c(0,1),ylab=expression(italic(p^threshold)),main="20 years projection without stocking - \n improvement 50% old level survival and 50% of downstream and upstream migration at Poutes")
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Poutes 50% x Amélioration survie 100%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
#============================
# AMELIORATION SURVIE 100%
#============================
b=mean(bugs_level_s)/10

level_s_fake=array(0,dim=c(1,T+20))
for (t in (T+1):(T+10)){			#On augmente progressivement
	level_s_fake[t]=level_s_fake[t-1]+b
}
for (t in (T+11):(T+20)){			#On maintient au niveau
	level_s_fake[t]=level_s_fake[t-1]
}
...
plot(1,1,type="n",axes=FALSE,xlim=c(0.5,20.5),xlab="Years",ylim=c(0,1),ylab=expression(italic(p^threshold)),main="20 years projection without stocking - \n improvement 100% old level survival and 50% of downstream and upstream migration at Poutes")
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# POUTES 100% x AMELIORATION SURVIE 50%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot(1,1,type="n",axes=FALSE,xlim=c(0.5,20.5),xlab="Years",ylim=c(0,1),ylab=expression(italic(p^threshold)),main="20 years projection without stocking - \n improvement 50% old level survival and 100% of downstream and upstream migration at Poutes")
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# POUTES 100% x AMELIORATION SURVIE 100%
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot(1,1,type="n",axes=FALSE,xlim=c(0.5,20.5),xlab="Years",ylim=c(0,1),ylab=expression(italic(p^threshold)),main="20 years projection without stocking - \n improvement 100% old level survival and 100% of downstream and upstream migration at Poutes")
