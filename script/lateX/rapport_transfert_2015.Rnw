...
##Les CODA du modèle définitif pour ce rapport = C:/Users/utilisateur/workspace/ModeleDynamiquePop/data/CODA/2016_01_20_standard_thin200
...
imgwd<-"C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2015/"
tabwd<-"C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/tab/2015/"
...
\includepdf{\Sexpr{imgwd}PageDeGarde_2015.pdf}
...
if (chunk_true==1){
	...
	rho_surv=read.coda("C:/Users/utilisateur/workspace/ModeleDynamiquePop/data/CODA/2016_03_01/rho_surv_juvCODAchain1.txt","C:/Users/utilisateur/workspace/ModeleDynamiquePop/data/CODA/2016_03_01/rho_surv_juvCODAindex.txt")
...
\begin{figure}
   \centering
    \includegraphics[width=0.5\textwidth,keepaspectratio]{\Sexpr{imgwd}loi_beta_2_2.pdf}
...
\begin{figure}
   \centering
    \includegraphics[width=0.6\textwidth,keepaspectratio]{\Sexpr{imgwd}rho_surv.pdf}
...
\begin{figure}
  \includegraphics[width=0.9\textwidth,keepaspectratio]{\Sexpr{imgwd}Devalpomi.pdf}
...
\input{\Sexpr{tabwd}ratio_surf.tex}

\input{\Sexpr{tabwd}ratio_interbar.tex}
...
\begin{figure}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{\Sexpr{imgwd}RelationCalibration2_2015_10_07.pdf}
...
\begin{figure}
    \includegraphics[width=0.55\textwidth,keepaspectratio]{\Sexpr{imgwd}RelationCalibration_2015_10_07.pdf}
    \caption[Relation entre le nombre d'individus capturé en 5 min (IA) et la
    densité de tacons 0+]{Relation entre le nombre d'individus capturé en 5 min (IA) et la
    densité de tacons 0+. Les boxplots indiquent les quantiles à 2.5, 25,
...
load(file = "C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/data/SpawnersRedds_GeniteursPotentiels_2016.03.07.RData")
...
\Sexpr{round(mean(ratio_S_V[,13:40]),2)}). Le secteur 2 reçoit, quant à lui en
moyenne (depuis 1986) \Sexpr{round(mean(ratio_S_L[,13:40])*100,1)}\% des
géniteurs et le secteur le plus amont,
\Sexpr{round(mean(ratio_S_P[,13:40])*100,1)}\% (moyenne depuis 1986). Rapporté à la disponibilité des habitats pour la production de juvéniles, on constate que
...
\begin{figure}[h]
     \includegraphics[width=0.9\textwidth,keepaspectratio]{\Sexpr{imgwd}SpawnersRedds_GeniteursPotentiels_2016_03_07.pdf}
...
#(ça évite de pourrir mon rapport rnw) afin de générer le pdf dans sweave (sinon il ne gère pas les accents)
if (chunk_true==1){
load(file = "C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/data/Redds_kappa_2016.03.07.RData")
...
\begin{figure}[h]
     \includegraphics[width=0.7\textwidth,keepaspectratio]{\Sexpr{imgwd}Redds_kappa_2016_03_07.pdf}
...
#je créé un save.image à partir du script figures_modèle_VF.R afin de ne réintégrer que le load 
#(ça évite de pourrir mon rapport rnw) afin de générer le pdf dans sweave (sinon il ne gère pas les accents)
load(file = "C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/data/dd_2016.03.08.RData")
...
\begin{figure}[!ht]
     \includegraphics[width=0.7\textwidth,keepaspectratio]{\Sexpr{imgwd}dd_2016_03_08.pdf}
...
#Recopié du script figures_model_VF
	load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/data/JuvProdRatioGeni_2016.03.08.RData")
...
\Sexpr{round(mean(diff_ratio_V_q[7:40,3])*100,1)}\% de géniteurs potentiels de
plus par rapport à ce qu'il produit, le secteur Langeac-Poutès \og reçoit \fg{}
en moyenne \Sexpr{abs(round(mean(diff_ratio_L_q[7:40,3])*100,1))}\% de géniteurs
...
\Sexpr{round(mean(diff_ratio_V_q[38:40,3])*100,1)}\% et
\Sexpr{round(mean(diff_ratio_P_q[38:40,3])*100,1)}\% de géniteurs de plus par
rapport aux juvéniles produits sur ces secteurs.


\begin{figure}[h!]
  %\centering
    \includegraphics{\Sexpr{imgwd}JuvProdRatioGeni_2016_03_08.pdf}
...
#je créé un save.image à partir du script figures_modèle_VF.R afin de ne réintégrer que le load 
#(ça évite de pourrir mon rapport rnw) afin de générer le pdf dans sweave (sinon il ne gère pas les accents)
load(file = "C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/data/SurvivalJuv2Ad_2016.03.08.RData")
...
années 80) un taux de transition médian de l'ordre de \Sexpr{round(s_q[7,3]*100,2)}\% contre 2\% dans la version précédente du modèle \citep{legrand_transfert_2014} \footnote{Pour rappel, 
...
baisse, par rapport à la précédente mise à jour \citep{legrand_transfert_2014} avec un taux de transition de \Sexpr{round(s_q[T,3]*100,2)}\% contre 0.56\% précédemment \footnote{rappelons que le taux de transition initialement estimé par \citet{dauphin_viability_2013} était de 0.17\%}.


\begin{figure}[!ht]
     \includegraphics[width=0.7\textwidth,keepaspectratio]{\Sexpr{imgwd}SurvivalJuv2Ad_2016_03_08.pdf}
...
alv<-read.csv("C:/Users/utilisateur/workspace/ModeleDynamiquePop/data/AlevinageSecteur.csv",sep=";")
...
\begin{figure}
  \includegraphics[width=0.9\textwidth,keepaspectratio]{\Sexpr{imgwd}RepartitionSpatiale_juv_totaux_ratio.pdf}
...
\begin{figure}
  \includegraphics[width=\textwidth,keepaspectratio]{\Sexpr{imgwd}Alv_deverse.pdf}
  \caption[Nombre d'alevins déversés par an et par secteur]{Nombre d'alevins déversés par an et par secteur.}
  \label{alv_dev}
\end{figure}

\begin{figure}
     \includegraphics[width=0.9\textwidth,keepaspectratio]{\Sexpr{imgwd}res_wild_poutes.pdf}
...
\begin{figure}
  \includegraphics[width=0.9\textwidth,keepaspectratio]{\Sexpr{imgwd}RepartitionSpatiale_juv_wild_ratio.pdf}
...
load(file = "C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/data/2016_03_15_AnalyseRetro.Rdata")
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}RetourVersLeFutur_2016_03_15.pdf}
...
de projection, de \Sexpr{round(mean(ras_p_under_500_vichy[16:20])*100,1)}\% et celle d'observer moins de 100 individus est très faible (\Sexpr{round(mean(ras_p_under_100_vichy[16:20])*100,1)}\%) (figure
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}TotalReturns_proj20years_2016_03_11.pdf}
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}Threshold_2016_03_11.pdf}
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}50poutes_TotalReturns_proj20years_2016_01_20.pdf}
     \caption[Retours d'adultes à Vichy avec arrêt des repeuplements et
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}50poutes_Threshold_2016_01_20.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
...
pdf(file="C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2016/100poutes_TotalReturns_proj20years_2016_01_20.pdf")#,width=800,height=800)
...
pdf(file="C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2016/100poutes_Threshold_2016_01_20.pdf")#,width=800,height=800)
...
nombre médian de \Sexpr{round(median(p100_N_vichy[,(T+10):(T+20)]),0)} individus à Vichy sur
...
(\Sexpr{round(mean(p100_p_under_500_vichy[16:20])*100,1)}\% en moyenne
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}100poutes_TotalReturns_proj20years_2016_01_20.pdf}
     \caption[Retours d'adultes à Vichy avec arrêt des repeuplements et
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}100poutes_Threshold_2016_01_20.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
...
pdf(file="C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2016/50ImprovementSurvival_TotalReturns_proj20years_2016_03_14.pdf")#,width=800,height=800)
...
pdf(file="C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2016/50ImprovementSurvival_Threshold_2016_03_14.pdf")#,width=800,height=800)
...
période de projection de \Sexpr{round(median(s50_N_vichy[,(T+20-9):(T+20)]),0)}
...
\Sexpr{round(mean(s50_p_under_500_vichy[16:20])*100,1)}\%) (figure \ref{fig_seuil_20ans_survivalImpro50}).


\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}50ImprovementSurvival_TotalReturns_proj20years_2016_03_14.pdf}
     \caption[Retours d'adultes à Vichy avec arrêt des repeuplements et
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}50ImprovementSurvival_Threshold_2016_03_14.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
     d'adultes à Vichy avec arrêt des repeuplements et amélioration
...
pdf(file="C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2016/100ImprovementSurvival_TotalReturns_proj20years_2016_03_14.pdf")#,width=800,height=800)
...
pdf(file="C:/Users/utilisateur/workspace/ModeleDynamiquePop/script/lateX/illustrations/2016/100ImprovementSurvival_Threshold_2016_03_14.pdf")#,width=800,height=800)
...
médian de \Sexpr{round(median(s100_N_vichy[,(T+20-9):(T+20)]),0)} individus (figure
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}100ImprovementSurvival_TotalReturns_proj20years_2016_03_14.pdf}
     \caption[Retours d'adultes à Vichy avec arrêt des repeuplements et
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}100ImprovementSurvival_Threshold_2016_03_14.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
     d'adultes à Vichy avec arrêt des repeuplements et amélioration
...
#load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/2016_01_20_OuvertureDevalaison_2016_03_14.RData")
...
#On récupère les données après lancement du script SimulationMortalitéDevalaison
#load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/2016_11_03_Devalaisonac_rho_poutes_Surf_thin200.RData")
load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/2016_07_01_Devalaisonac_rho_poutes_Surf_2016_12_21.RData")
#==========================================
# CHAP : Figure : TotalReturns_proj20years
#==========================================
#Renomme N_vichy pour pouvoir faire calcul dans sweave sans que ça reste sur la dernière valeur si je relance le script
...
load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/2016_07_01_Devalaisonac_rho_poutes_Surf&Prod_2016_12_20.RData")
...
\begin{itemize}
  ...
  \Sexpr{round(median(dev_s_N_vichy[,(T+16):(T+20)]),0)} individus (figure
  ...
  \Sexpr{round(mean(dev_s_p_under_500_vichy[16:20])*100,2)}\% (figure
...
\begin{itemize}
  ...
  \Sexpr{round(median(dev_N_vichy[,(T+16):(T+20)]),0)} (figure
  \ref{fig_retour_20ans_devalRhoPoutes}),
  \item la probabilité d'observer moins de 500 adultes à Vichy sur les 5
  dernières années de la période de projection est de 
  \Sexpr{round(mean(dev_p_under_500_vichy[16:20])*100,1)}\% (figure
  \ref{fig_seuil_20ans_devalRhoPoutes}).
\end{itemize}


\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}DevalMorta_TotalReturns_proj20years_Surf_rhopoutes_2016_11_03.pdf}
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}DevalaisonMorta_Threshold_Surf_rhopoutes_2016_11_03.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
    ...
    \Sexpr{1974+T+1}--\Sexpr{1974+T+20}, dans le scénario de suppression des impacts à la dévalaison
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}DevalMorta_TotalReturns_proj20years_AvecRhoPoutes_2016_04_08.pdf}
     \caption[Retours d'adultes à Vichy avec suppression des impacts à
     la dévalaison dans 11 ouvrages hydroélectriques (hypothèse de répartition
     des juvéniles au \textit{prorata} des surfaces disponibles
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}DevalaisonMorta_Threshold_AvecRhoPoutes_2016_04_08.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
     d'adultes à Vichy avec la suppression des impacts à la
     dévalaison dans les ourages hydroélectriques (hypothèse de répartition des
     juvéniles au \textit{prorata} des surfaces disponibles
...
#load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/2016_01_20_OuvertureDevalaison_ssDore_2016_03_17.RData")
load("C:/Users/utilisateur/workspace/ModeleDynamiquePop/2016_07_01_Devalaisonac_rho_poutes_Surf&prod_0_dore_2016_12_21.RData")
...
période de projection est de \Sexpr{round(median(dev_sd_N_vichy[,(T+16):(T+20)]),0)} et la probabilité d'observer moins de 500 individus à Vichy est de \Sexpr{round(mean(dev_sd_p_under_500_vichy[16:20])*100,1)}\%.


\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}DevalMorta_TotalReturns_ssDore_proj20years_2016_03_14.pdf}
     \caption[Retours d'adultes à Vichy avec suppression des impacts à
...
\begin{figure}[ht]
     \includegraphics{\Sexpr{imgwd}DevalaisonMorta_ssDore_Threshold_2016_03_14.pdf}
     \caption[Probabilité d'atteindre certains seuils de nombre
     d'adultes à Vichy avec la suppression des impacts à la
     ...
     retours à Vichy sur la période \Sexpr{1974+T+1}--\Sexpr{1974+T+20}, dans le scénario de suppression
...
\begin{itemize}
  ...
  importante (\Sexpr{round(mean(pourcentage_N_vichy_q[26:40,3])*100,0)}\% en
  ...
  (\Sexpr{round(mean(N_vichy_q[31:40,3]),0)} individus en moyenne sur les 10
