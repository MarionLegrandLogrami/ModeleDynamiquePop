...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/s_juv2ad.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/m_surv.png}%{a_juv.png}
     \caption{m\_surv}
     \label{m_surv} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/m_surv.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_VB_deval.png}
     \caption{beta\_Q\_VB\_deval}
     \label{beta_Q_VB_deval} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_VB_deval.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_MSL_mont.png}
     \caption{beta\_Q\_MSL\_mont}
     \label{beta_Q_MSL_mont} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_MSL_mont.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_MSL_deval.png}
     \caption{beta\_Q\_MSL\_deval}
     \label{beta_Q_MSL_deval} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_MSL_deval.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/corr_Q_surv.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/plot_Q_surv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/corr_Q_surv_data.png}%{a_juv.png}
...
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/I_mm.png}%{a_juv.png}
...
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/ratio_surv.png}
%      \caption{ratio\_surv}
%      \label{ratio_surv}
% \end{figure}
% 
% \input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/ratio_surv.tex}
% \clearpage
...
% 
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_surv.png}
%      \caption{p\_surv}
%      \label{p_surv}
% \end{figure}
% 
% \input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/p_surv.tex}
% 
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_vichy.png}%{a_juv.png}
     \caption{sigma\_vichy}
     \label{sigma_vichy} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_vichy.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/N_vichy.png}%{a_juv.png}
     \caption{N\_vichy}
     \label{N_vichy} 
\end{figure}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_vichy_std.png}%{a_juv.png}
...
N\_Poutès représente les effectifs de saumon ayant franchi Poutès. Durant la période où la station de comptage a fonctionné, les effectifs comptés sont exhaustifs et représentés par des point noir. Depuis le réaménagement de l'ouvrage (2021), la période de transparence ne permet plus le comptage. Les effectifs sont estimés (boxplot).
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/adultes_vichy.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/adultes_langeac.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/proportion_adultes.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_comptage_L.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/N_langeac_obs.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/rho_station.png}%{a_juv.png}
     \caption{rho\_station}
     \label{rho_station} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/rho_station.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/adjust_p_A.png}%{a_juv.png}
     \caption{adjust\_p\_A}
     \label{adjust_p_A} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/adjust_p_A.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/adjust_p_L.png}%{a_juv.png}
     \caption{adjust\_p\_L}
     \label{adjust_p_L} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/adjust_p_L.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/adjust_p_P.png}%{a_juv.png}
     \caption{adjust\_p\_P}
     \label{adjust_p_P} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/adjust_p_P.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_p_alagnon_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_p_langeac_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_p_poutes_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_p_alagnon.png}%{a_juv.png}
     \caption{sigma\_p\_alagnon}
     \label{sigma_p_alagnon} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_p_alagnon.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_p_langeac.png}%{a_juv.png}
     \caption{sigma\_p\_langeac}
     \label{sigma_p_langeac} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_p_langeac.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_p_poutes.png}%{a_juv.png}
     \caption{sigma\_p\_poutes}
     \label{sigma_p_poutes} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_p_poutes.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/hel_effect.png}%{a_juv.png}
     \caption{hel\_effect}
     \label{hel_effect} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/hel_effect.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/zone_effect_V.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/zone_effect_A.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/zone_effect_L.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/zone_effect_P.png}%{a_juv.png}
...
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_comptage.png}%{a_juv.png}
%      \caption{p\_comptage}
%      \label{p_comptage} 
% \end{figure}
% 
...
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_p_comptage.png}%{a_juv.png}
%      \caption{sigma\_p\_comptage}
%      \label{sigma_p_comptage} 
% \end{figure}
% 
% \input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_p_comptage.tex}
% \clearpage
...
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/N_langeac_count.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_L_mont_P.png}
     \caption{beta\_Q\_L\_mont\_P}
     \label{beta_Q_L_mont_P}
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_L_mont_P.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_L_mont_A.png}
     \caption{beta\_Q\_L\_mont\_A}
     \label{beta_Q_L_mont_A}
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_L_mont_A.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_VB_mont_P.png}
     \caption{beta\_Q\_VB\_mont\_P}
     \label{beta_Q_VB_mont_P}
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_VB_mont_P.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_VB_mont_A.png}
     \caption{beta\_Q\_VB\_mont\_A}
     \label{beta_Q_VB_mont_A}
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_VB_mont_A.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_P_mont_P.png}
     \caption{beta\_Q\_P\_mont\_P}
     \label{beta_Q_P_mont_P}
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_P_mont_P.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_Q_P_mont_A.png}
     \caption{beta\_Q\_P\_mont\_A}
     \label{beta_Q_P_mont_A}
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_Q_P_mont_A.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/plot_Q.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/corr_Q_rep.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/a.png}%{a_juv.png}
     \caption{a}
     \label{a} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/a.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/a_juv.png}%{a_juv.png}
     \caption{a\_juv}
     \label{a_juv} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/a_juv.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/Rmax.png}%{a_juv.png}
     \caption{Rmax}
     \label{Rmax} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/Rmax.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_Rmax_V.png}
     \caption{p\_Rmax\_V}
     \label{p_Rmax_V} 
\end{figure}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_Rmax_A.png}
     \caption{p\_Rmax\_A}
     \label{p_Rmax_A} 
\end{figure}
\clearpage
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_Rmax_L.png}
     \caption{p\_Rmax\_L}
     \label{p_Rmax_L} 
\end{figure}
\clearpage
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/p_Rmax_P.png}
     \caption{p\_Rmax\_P}
     \label{p_Rmax_P} 
\end{figure}
\clearpage
...
%\begin{figure}[ht]
%     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/mu_tau.png}%{a_juv.png}
%     \caption{mu\_tau}
%     \label{mu_tau} 
%\end{figure}

%\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/mu_tau.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/alpha_sigma.png}%{a_juv.png}
     \caption{alpha\_sigma}
     \label{alpha_sigma} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/alpha_sigma.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/mu_sigma.png}%{a_juv.png}
     \caption{mu\_sigma}
     \label{mu_sigma} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/mu_sigma.tex}
...
%\begin{figure}[ht]
%     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/beta_tau.png}%{a_juv.png}
%     \caption{beta\_tau}
%     \label{beta_tau} 
%\end{figure}
%
%\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/beta_tau.tex}
%
...
%\begin{figure}[ht]
%\includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/rho_D.png}%{a_juv.png}
%		\caption{rho\_D}
%\label{rho_D} 
%\end{figure}
%
%
%\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/rho_D.tex}
%
...
%\begin{figure}[ht]
%     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/nu_wild.png}
%     \caption{nu\_wild}
%     \label{nu_wild} 
%\end{figure}
%
%\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/nu_wild.tex}
%\clearpage
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/nu_d.png}
     \caption{nu\_d}
     \label{nu_d} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/nu_d.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_wild_moy.png}%{a_juv.png}
     \caption{sigma\_wild\_moy}
     \label{sigma_wild_moy} 
\end{figure}


\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_wild_moy.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_juv_moy.png}%{a_juv.png}
     \caption{sigma\_juv\_moy}
     \label{sigma_juv_moy} 
\end{figure}


\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_juv_moy.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_egg_moy.png}%{a_juv.png}
     \caption{sigma\_egg\_moy}
     \label{sigma_egg_moy} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_egg_moy.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_wild_site.png}%{a_juv.png}
     \caption{sigma\_wild\_site}
     \label{sigma_wild_site} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_wild_site.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_juv_site.png}%{a_juv.png}
     \caption{sigma\_juv\_site}
     \label{sigma_juv_site} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_juv_site.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/sigma_egg_site.png}%{a_juv.png}
     \caption{sigma\_egg\_site}
     \label{sigma_egg_site} 
\end{figure}

\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/sigma_egg_site.tex}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_wild_moy_V.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_wild_moy_A.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_wild_moy_L.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_wild_moy_P.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_juv_moy_V.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_juv_moy_A.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_juv_moy_L.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_juv_moy_P.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_egg_moy_V.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/d_egg_moy_L.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_wild_moy_V_std.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_wild_moy_A_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_wild_moy_L_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_wild_moy_P_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_juv_moy_V_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_juv_moy_A_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_juv_moy_L_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/res_juv_moy_P_std.png}%{a_juv.png}
...
\begin{figure}[ht]
     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/corr_res_wild.png}
     \caption{res\_juv\_moy\_P\_std}
     \label{res_juv_moy_P_std} 
\end{figure}
...
% \begin{figure}[ht]
%     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/level_s.png}%{a_juv.png}
%     \caption{level\_s}
%     \label{level_s}
% \end{figure}
% 
% \input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/level_s.tex}
% \clearpage
...
% \begin{figure}[ht]
%      \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/tau_Q.png}
%      \caption{tau\_Q :précision de la loi normale dans laquelle on tire L_s_juv2ad}
%      \label{tau\_Q} 
% \end{figure}
% 
% \input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/tau_Q.tex}
%\clearpage
...
%\begin{figure}[ht]
%     \includegraphics{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/img/2025_07/rho_poutes.png}%{a_juv.png}
%     \caption{rho\_poutes}
%     \label{rho_poutes} 
%\end{figure}
%
%\input{D:/Documents/Workspace_eclipse/ModeleDynamiquePop/tab/2025_07/rho_poutes.tex}
%\clearpage
