...
gen_descendant=array(0,dim=c(5000,T+1))
...
#Les 6 premi�res ann�es sont identiques au sc�nario standard puisque les cohortes de juv�niles � l'origine du retour des adultes d�pendent des 3 ann�es de production ant�rieures)
#res_wild_vichy, alagnon, langeac est bien indic� t car ils commencent � 2 et que d_moy_vichy, alagnon, langeac est indic� t+1
for (t in 1:6){
	for (i in 1:5000){ 
